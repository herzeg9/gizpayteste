    ...
    <div style={{ background: giz.deep, color: giz.fgDark }}>
      ...
      <section style={{ background: giz.lightAlt, color: giz.fgLight }}>
        <div className="mx-auto w-full max-w-[1200px] px-5 py-20 sm:px-6 sm:py-24">
          ...
          <Reveal delay={80}>
            <div
              className="mt-12 overflow-hidden rounded-[18px] border bg-white"
              style={{ borderColor: giz.borderLight }}
            >
              <div
                className="hidden grid-cols-[1.1fr_1.2fr_1.2fr] border-b text-[11px] uppercase tracking-[0.12em] sm:grid"
                style={{ borderColor: giz.borderLight, color: giz.mutedLight }}
              >
                <span className="px-5 py-3.5">Critério</span>
                <span
                ...
                <span className="px-5 py-3.5">Intermediário tradicional</span>
              </div>

              {COMPARATIVO.map((linha) => (
                <div
                  key={linha.criterio}
                  className="grid gap-1 border-b px-5 py-4 last:border-0 sm:grid-cols-[1.1fr_1.2fr_1.2fr] sm:gap-0 sm:px-0 sm:py-0"
                  style={{ borderColor: giz.borderLight }}
                >
                  <span
                    className="text-sm font-medium sm:px-5 sm:py-4"
                    style={{ color: giz.fgLight }}
                  >
                    {linha.criterio}
                  </span>
                  <span
                    className="flex items-start gap-2 text-sm sm:px-5 sm:py-4"
                    style={{
                      color: giz.fgLight,
                      background: linha.vitoria ? "rgba(74,222,128,0.09)" : undefined,
                    }}
                  >
                    <Check
                  ...
                  <span
                    className="text-sm sm:px-5 sm:py-4"
                    style={{ color: giz.mutedLight }}
                  >
                    {linha.outro}
                  </span>
